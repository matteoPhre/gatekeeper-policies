import {
  ...
  type PasswordCompromisedPasswordValidationResult,
...
export class IdentityPolicyEngine {
  ...
  public async validateComplexityWithExtensions(
    password: string,
  ...
  public daysRemainingInGracePeriod(
    passwordCreatedAt: PasswordCreatedAtInput,
  ): number {
  ...
  public isMinimumPasswordAgeSatisfied(
    passwordCreatedAt: PasswordCreatedAtInput,
  ): boolean {
